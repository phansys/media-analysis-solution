...
//     describe('#startTranslation', function() {

//         beforeEach(function() {});

//         afterEach(function() {
//           AWS.restore('Translate');
//         });

//         it('should return information about the transcription job if startTranslation is successful', function(done) {

//             AWS.mock('Translate', 'startTranslation', function(params, callback) {
//                 callback(null, start_job_response);
//             });

//             let _transcribe = new Translate();
//             _transcribe.startTranslation(event_info, function(err, data) {
//                 if (err) done(err);
//                 else {
...
//         it('should return error if startTranslation fails', function(done) {
...
//             AWS.mock('Translate', 'getTranscriptionJob', function(params, callback) {
